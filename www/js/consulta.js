        ...
        ag.get()
            .then((querySnapshot) => {
                querySnapshot.forEach(doc => {
                    ...
                    $("#TableData").append("<td scope='col'><a href='" + cordova.file.applicationDirectory +
                        "www/editarClientes.html?telefone=" + doc.data().telefone + "'>Editar</a></td>&nbsp; <a href='" +
                        cordova.file.applicationDirectory + "www/excluirClientes.html?telefone=" + doc.data().telefone + "'>Excluir</a></td>");
                    $("#TableData").append("</tr>");
                });
            })
            .catch(error => {
                console.log("Erro para fazer a consulta: " + error);
            });
